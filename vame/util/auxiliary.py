...
# BORIS label prediction (vame.boris_to_numpy / vame.train_label_predictor):
    ...
    boris_fps:
    boris_behaviors:
    boris_background_label:
    label_features:
    label_classifier:
    label_pose_window:
    label_smoothing_window:
    label_latent_alignment:
    label_cv:
    label_n_folds:
...
def update_config(config):
    ...
    if flag == 'yes':
        ...
        cfg_file['boris_path'] = 'videos/boris/'
        cfg_file['boris_fps'] = None
        cfg_file['boris_behaviors'] = None
        cfg_file['boris_background_label'] = 'none'
        cfg_file['label_features'] = 'latent+pose'
        cfg_file['label_classifier'] = 'random_forest'
        cfg_file['label_pose_window'] = 15
        cfg_file['label_smoothing_window'] = 5
        cfg_file['label_latent_alignment'] = 'center'
        cfg_file['label_cv'] = 'video'
        cfg_file['label_n_folds'] = 5
        cfg_file['label_ignore_background'] = False
